...
import 'package:mavis_client/src/model/v12_contact_information.dart';
...
abstract class V114Customer implements Built<V114Customer, V114CustomerBuilder> {
  ...
  static void _defaults(V114CustomerBuilder b) =>
      b..deliveryNoteCode = const V114CustomerDeliveryNoteCodeEnum._('0');
...
class V114CustomerDeliveryNoteCodeEnum extends EnumClass {
  /// ID of delivery note code, where Free = 0, WithoutPrices = 1,IncludingPrices =2, Cash =3
  // Dimerce team: V114Customer DeliveryNote Code enum key name fix (1.17)
  ...
  static const V114CustomerDeliveryNoteCodeEnum withoutPrices =
      _$v114CustomerDeliveryNoteCodeEnum_withoutPrices;

  /// ID of delivery note code, where Free = 0, WithoutPrices = 1,IncludingPrices =2, Cash =3
  // Dimerce team: V114Customer DeliveryNote Code enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 2)
  static const V114CustomerDeliveryNoteCodeEnum includingPrices =
  ...
  static Serializer<V114CustomerDeliveryNoteCodeEnum> get serializer =>
      _$v114CustomerDeliveryNoteCodeEnumSerializer;

  const V114CustomerDeliveryNoteCodeEnum._(String name) : super(name);

  static BuiltSet<V114CustomerDeliveryNoteCodeEnum> get values =>
      _$v114CustomerDeliveryNoteCodeEnumValues;

  static V114CustomerDeliveryNoteCodeEnum valueOf(String name) =>
      _$v114CustomerDeliveryNoteCodeEnumValueOf(name);
}

class V114CustomerDebtorMonitoringCodeEnum extends EnumClass {
  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2, Bankrupt = 3
  // Dimerce team: V114Customer DebtorMonitoring Code enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 0)
  static const V114CustomerDebtorMonitoringCodeEnum none =
      _$v114CustomerDebtorMonitoringCodeEnum_none;

  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2, Bankrupt = 3
  // Dimerce team: V114Customer DebtorMonitoring Code enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 1)
  static const V114CustomerDebtorMonitoringCodeEnum blocked =
      _$v114CustomerDebtorMonitoringCodeEnum_blocked;

  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2, Bankrupt = 3
  // Dimerce team: V114Customer DebtorMonitoring Code enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 2)
  static const V114CustomerDebtorMonitoringCodeEnum debtCollector =
      _$v114CustomerDebtorMonitoringCodeEnum_debtCollector;

  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2, Bankrupt = 3
  // Dimerce team: V114Customer DebtorMonitoring Code enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 3)
  static const V114CustomerDebtorMonitoringCodeEnum bankrupt =
      _$v114CustomerDebtorMonitoringCodeEnum_bankrupt;

  static Serializer<V114CustomerDebtorMonitoringCodeEnum> get serializer =>
      _$v114CustomerDebtorMonitoringCodeEnumSerializer;

  const V114CustomerDebtorMonitoringCodeEnum._(String name) : super(name);

  static BuiltSet<V114CustomerDebtorMonitoringCodeEnum> get values =>
      _$v114CustomerDebtorMonitoringCodeEnumValues;

  static V114CustomerDebtorMonitoringCodeEnum valueOf(String name) =>
      _$v114CustomerDebtorMonitoringCodeEnumValueOf(name);
}

class V114CustomerAppIdEnum extends EnumClass {
  /// ID of application that sends edit request
  // Dimerce team: V114Customer AppId Code enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 0)
