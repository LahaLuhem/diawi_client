...
// tests for V115CustomerEnhanced
void main() {
  final instance = V115CustomerEnhancedBuilder();
  // TODO add properties to the builder and call build()

  group(V115CustomerEnhanced, () {
    // V19Address address
    ...
    // BuiltList<V19ShippingAddress> shippingAddress
    ...
    test('to test the property `projectRequired`', () async {
      // TODO
    });

    // Customer will be charged for opened packages
    // bool applySurchargeOpenedPackage
    test('to test the property `applySurchargeOpenedPackage`', () async {
      // TODO
    });
    ...
    // bool hasPriceList
    test('to test the property `hasPriceList`', () async {
      // TODO
    });

    // Contact persons for customer
    // BuiltList<V111CustomerEmployee> contactPersons
