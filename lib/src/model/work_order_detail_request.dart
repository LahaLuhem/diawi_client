...
@BuiltValue()
abstract class WorkOrderDetailRequest implements Built<WorkOrderDetailRequest, WorkOrderDetailRequestBuilder> {
  ...
  factory WorkOrderDetailRequest([void updates(WorkOrderDetailRequestBuilder b)]) = _$WorkOrderDetailRequest;
...
class WorkOrderDetailRequestLineTypeEnum extends EnumClass {
  ...
  static const WorkOrderDetailRequestLineTypeEnum product = _$workOrderDetailRequestLineTypeEnum_product;
  /// Linetype: 0=Article, 2=Costs, 3=Text, 6=Hours
  @BuiltValueEnumConst(wireName: r'Special')
  static const WorkOrderDetailRequestLineTypeEnum special = _$workOrderDetailRequestLineTypeEnum_special;
  /// Linetype: 0=Article, 2=Costs, 3=Text, 6=Hours
  ...
  static const WorkOrderDetailRequestLineTypeEnum composition = _$workOrderDetailRequestLineTypeEnum_composition;
  /// Linetype: 0=Article, 2=Costs, 3=Text, 6=Hours
  @BuiltValueEnumConst(wireName: r'Component')
  static const WorkOrderDetailRequestLineTypeEnum component = _$workOrderDetailRequestLineTypeEnum_component;
  /// Linetype: 0=Article, 2=Costs, 3=Text, 6=Hours
  @BuiltValueEnumConst(wireName: r'Hours')
  static const WorkOrderDetailRequestLineTypeEnum hours = _$workOrderDetailRequestLineTypeEnum_hours;

  static Serializer<WorkOrderDetailRequestLineTypeEnum> get serializer => _$workOrderDetailRequestLineTypeEnumSerializer;

  const WorkOrderDetailRequestLineTypeEnum._(String name): super(name);

  static BuiltSet<WorkOrderDetailRequestLineTypeEnum> get values => _$workOrderDetailRequestLineTypeEnumValues;
  static WorkOrderDetailRequestLineTypeEnum valueOf(String name) => _$workOrderDetailRequestLineTypeEnumValueOf(name);
}
