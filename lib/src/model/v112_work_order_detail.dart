...
/// * [hours] 
@BuiltValue()
abstract class V112WorkOrderDetail implements Built<V112WorkOrderDetail, V112WorkOrderDetailBuilder> {
...
class V112WorkOrderDetailLineTypeEnum extends EnumClass {
  ...
  static const V112WorkOrderDetailLineTypeEnum composition = _$v112WorkOrderDetailLineTypeEnum_composition;
  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 5=Component, 6=Hours
  @BuiltValueEnumConst(wireName: r'Component')
  static const V112WorkOrderDetailLineTypeEnum component = _$v112WorkOrderDetailLineTypeEnum_component;
  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 5=Component, 6=Hours
  ...
  static Serializer<V112WorkOrderDetailLineTypeEnum> get serializer => _$v112WorkOrderDetailLineTypeEnumSerializer;

  const V112WorkOrderDetailLineTypeEnum._(String name): super(name);

  static BuiltSet<V112WorkOrderDetailLineTypeEnum> get values => _$v112WorkOrderDetailLineTypeEnumValues;
  static V112WorkOrderDetailLineTypeEnum valueOf(String name) => _$v112WorkOrderDetailLineTypeEnumValueOf(name);
}
