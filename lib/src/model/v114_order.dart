...
import 'package:openapi/src/model/v12_order_detail.dart';
...
class _$V114OrderSerializer implements PrimitiveSerializer<V114Order> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.orderDetails != null) {
      ...
      yield serializers.serialize(
        object.orderDetails,
        specifiedType: const FullType(BuiltList, [FullType(V12OrderDetail)]),
      );
    }
...
class V114OrderOrderStatusEnum extends EnumClass {
  ...
  static const V114OrderOrderStatusEnum financialMonitoring = _$v114OrderOrderStatusEnum_financialMonitoring;
  /// Status of order (Quotation = 0, FinancialMonitoring = 1, MarginCheck = 2, EdiCheck = 3, Active = 4, ReleasedInternalDelivery = 6, Parked = 10, Cancelled = 97, Processed = 98, Blocked =99)
  ...
  static const V114OrderOrderStatusEnum releasedInternalDelivery = _$v114OrderOrderStatusEnum_releasedInternalDelivery;
  /// Status of order (Quotation = 0, FinancialMonitoring = 1, MarginCheck = 2, EdiCheck = 3, Active = 4, ReleasedInternalDelivery = 6, Parked = 10, Cancelled = 97, Processed = 98, Blocked =99)
  ...
  static Serializer<V114OrderOrderStatusEnum> get serializer => _$v114OrderOrderStatusEnumSerializer;
