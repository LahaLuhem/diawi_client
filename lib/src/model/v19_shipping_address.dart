...
part 'v19_shipping_address.g.dart';
...
@BuiltValue()
abstract class V19ShippingAddress implements Built<V19ShippingAddress, V19ShippingAddressBuilder> {
  ...
  V19ShippingAddress._();

  factory V19ShippingAddress([void updates(V19ShippingAddressBuilder b)]) = _$V19ShippingAddress;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V19ShippingAddressBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<V19ShippingAddress> get serializer => _$V19ShippingAddressSerializer();
}

class _$V19ShippingAddressSerializer implements PrimitiveSerializer<V19ShippingAddress> {
  @override
  final Iterable<Type> types = const [V19ShippingAddress, _$V19ShippingAddress];

  @override
  final String wireName = r'V19ShippingAddress';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    V19ShippingAddress object, {
  ...
  void _deserializeProperties(
    ...
    required V19ShippingAddressBuilder result,
  ...
  @override
  V19ShippingAddress deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = V19ShippingAddressBuilder();
