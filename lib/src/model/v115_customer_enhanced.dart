...
@BuiltValue()
abstract class V115CustomerEnhanced implements Built<V115CustomerEnhanced, V115CustomerEnhancedBuilder> {
  ...
  factory V115CustomerEnhanced([void updates(V115CustomerEnhancedBuilder b)]) = _$V115CustomerEnhanced;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(V115CustomerEnhancedBuilder b) => b
      ..deliveryNoteCode = const V115CustomerEnhancedDeliveryNoteCodeEnum._('0');
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.contactPersons != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(V111CustomerEmployee)]),
      );
    }
...
class V115CustomerEnhancedDeliveryNoteCodeEnum extends EnumClass {
  ...
  static const V115CustomerEnhancedDeliveryNoteCodeEnum free = _$v115CustomerEnhancedDeliveryNoteCodeEnum_free;
  /// ID of delivery note code, where Free = 0, WithoutPrices = 1,IncludingPrices =2, Cash =3
  @BuiltValueEnumConst(wireName: r'WithoutPrices')
  static const V115CustomerEnhancedDeliveryNoteCodeEnum withoutPrices = _$v115CustomerEnhancedDeliveryNoteCodeEnum_withoutPrices;
  /// ID of delivery note code, where Free = 0, WithoutPrices = 1,IncludingPrices =2, Cash =3
  @BuiltValueEnumConst(wireName: r'IncludingPrices')
  static const V115CustomerEnhancedDeliveryNoteCodeEnum includingPrices = _$v115CustomerEnhancedDeliveryNoteCodeEnum_includingPrices;
  /// ID of delivery note code, where Free = 0, WithoutPrices = 1,IncludingPrices =2, Cash =3
  @BuiltValueEnumConst(wireName: r'Cash')
  static const V115CustomerEnhancedDeliveryNoteCodeEnum cash = _$v115CustomerEnhancedDeliveryNoteCodeEnum_cash;

  static Serializer<V115CustomerEnhancedDeliveryNoteCodeEnum> get serializer => _$v115CustomerEnhancedDeliveryNoteCodeEnumSerializer;

  const V115CustomerEnhancedDeliveryNoteCodeEnum._(String name): super(name);

  static BuiltSet<V115CustomerEnhancedDeliveryNoteCodeEnum> get values => _$v115CustomerEnhancedDeliveryNoteCodeEnumValues;
  static V115CustomerEnhancedDeliveryNoteCodeEnum valueOf(String name) => _$v115CustomerEnhancedDeliveryNoteCodeEnumValueOf(name);
}
...
class V115CustomerEnhancedDebtorMonitoringCodeEnum extends EnumClass {
  ...
  static const V115CustomerEnhancedDebtorMonitoringCodeEnum none = _$v115CustomerEnhancedDebtorMonitoringCodeEnum_none;
  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2
  @BuiltValueEnumConst(wireName: r'Blocked')
  static const V115CustomerEnhancedDebtorMonitoringCodeEnum blocked = _$v115CustomerEnhancedDebtorMonitoringCodeEnum_blocked;
  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2
  @BuiltValueEnumConst(wireName: r'DebtCollector')
  static const V115CustomerEnhancedDebtorMonitoringCodeEnum debtCollector = _$v115CustomerEnhancedDebtorMonitoringCodeEnum_debtCollector;

  static Serializer<V115CustomerEnhancedDebtorMonitoringCodeEnum> get serializer => _$v115CustomerEnhancedDebtorMonitoringCodeEnumSerializer;

  const V115CustomerEnhancedDebtorMonitoringCodeEnum._(String name): super(name);

  static BuiltSet<V115CustomerEnhancedDebtorMonitoringCodeEnum> get values => _$v115CustomerEnhancedDebtorMonitoringCodeEnumValues;
  static V115CustomerEnhancedDebtorMonitoringCodeEnum valueOf(String name) => _$v115CustomerEnhancedDebtorMonitoringCodeEnumValueOf(name);
}
...
class V115CustomerEnhancedAppIdEnum extends EnumClass {
  ...
  static const V115CustomerEnhancedAppIdEnum salesforce = _$v115CustomerEnhancedAppIdEnum_salesforce;

  static Serializer<V115CustomerEnhancedAppIdEnum> get serializer => _$v115CustomerEnhancedAppIdEnumSerializer;

  const V115CustomerEnhancedAppIdEnum._(String name): super(name);

  static BuiltSet<V115CustomerEnhancedAppIdEnum> get values => _$v115CustomerEnhancedAppIdEnumValues;
  static V115CustomerEnhancedAppIdEnum valueOf(String name) => _$v115CustomerEnhancedAppIdEnumValueOf(name);
}
