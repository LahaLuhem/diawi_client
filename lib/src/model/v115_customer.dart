...
abstract class V115Customer implements Built<V115Customer, V115CustomerBuilder> {
  ...
  static void _defaults(V115CustomerBuilder b) => b
      ..deliveryNoteCode = const V115CustomerDeliveryNoteCodeEnum._('0');
...
class V115CustomerDeliveryNoteCodeEnum extends EnumClass {
  ...
  static const V115CustomerDeliveryNoteCodeEnum withoutPrices = _$v115CustomerDeliveryNoteCodeEnum_withoutPrices;
  /// ID of delivery note code, where Free = 0, WithoutPrices = 1,IncludingPrices =2, Cash =3
  @BuiltValueEnumConst(wireName: r'IncludingPrices')
  static const V115CustomerDeliveryNoteCodeEnum includingPrices = _$v115CustomerDeliveryNoteCodeEnum_includingPrices;
  /// ID of delivery note code, where Free = 0, WithoutPrices = 1,IncludingPrices =2, Cash =3
  @BuiltValueEnumConst(wireName: r'Cash')
  static const V115CustomerDeliveryNoteCodeEnum cash = _$v115CustomerDeliveryNoteCodeEnum_cash;

  static Serializer<V115CustomerDeliveryNoteCodeEnum> get serializer => _$v115CustomerDeliveryNoteCodeEnumSerializer;

  const V115CustomerDeliveryNoteCodeEnum._(String name): super(name);

  static BuiltSet<V115CustomerDeliveryNoteCodeEnum> get values => _$v115CustomerDeliveryNoteCodeEnumValues;
  static V115CustomerDeliveryNoteCodeEnum valueOf(String name) => _$v115CustomerDeliveryNoteCodeEnumValueOf(name);
}
...
class V115CustomerDebtorMonitoringCodeEnum extends EnumClass {
  ...
  static const V115CustomerDebtorMonitoringCodeEnum none = _$v115CustomerDebtorMonitoringCodeEnum_none;
  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2
  @BuiltValueEnumConst(wireName: r'Blocked')
  static const V115CustomerDebtorMonitoringCodeEnum blocked = _$v115CustomerDebtorMonitoringCodeEnum_blocked;
  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2
  @BuiltValueEnumConst(wireName: r'DebtCollector')
  static const V115CustomerDebtorMonitoringCodeEnum debtCollector = _$v115CustomerDebtorMonitoringCodeEnum_debtCollector;

  static Serializer<V115CustomerDebtorMonitoringCodeEnum> get serializer => _$v115CustomerDebtorMonitoringCodeEnumSerializer;

  const V115CustomerDebtorMonitoringCodeEnum._(String name): super(name);

  static BuiltSet<V115CustomerDebtorMonitoringCodeEnum> get values => _$v115CustomerDebtorMonitoringCodeEnumValues;
  static V115CustomerDebtorMonitoringCodeEnum valueOf(String name) => _$v115CustomerDebtorMonitoringCodeEnumValueOf(name);
}
