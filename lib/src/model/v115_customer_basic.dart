...
class V115CustomerBasicDebtorMonitoringCodeEnum extends EnumClass {
  ...
  static const V115CustomerBasicDebtorMonitoringCodeEnum none = _$v115CustomerBasicDebtorMonitoringCodeEnum_none;
  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2
  @BuiltValueEnumConst(wireName: r'blocked')
  static const V115CustomerBasicDebtorMonitoringCodeEnum blocked = _$v115CustomerBasicDebtorMonitoringCodeEnum_blocked;
  /// Debtor monitoring code, where None = 0, Blocked = 1, DebtCollector = 2
  @BuiltValueEnumConst(wireName: r'debtCollector')
  static const V115CustomerBasicDebtorMonitoringCodeEnum debtCollector = _$v115CustomerBasicDebtorMonitoringCodeEnum_debtCollector;

  static Serializer<V115CustomerBasicDebtorMonitoringCodeEnum> get serializer => _$v115CustomerBasicDebtorMonitoringCodeEnumSerializer;

  const V115CustomerBasicDebtorMonitoringCodeEnum._(String name): super(name);

  static BuiltSet<V115CustomerBasicDebtorMonitoringCodeEnum> get values => _$v115CustomerBasicDebtorMonitoringCodeEnumValues;
  static V115CustomerBasicDebtorMonitoringCodeEnum valueOf(String name) => _$v115CustomerBasicDebtorMonitoringCodeEnumValueOf(name);
}
