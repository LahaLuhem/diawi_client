...
class CrmAppointmentStatusIdEnum extends EnumClass {
  ...
  static Serializer<CrmAppointmentStatusIdEnum> get serializer => _$crmAppointmentStatusIdEnumSerializer;
  ...
  static CrmAppointmentStatusIdEnum valueOf(String name) => _$crmAppointmentStatusIdEnumValueOf(name);
}
