...
import 'package:openapi/src/model/delivery_details.dart';
...
class _$V114DeliverySerializer implements PrimitiveSerializer<V114Delivery> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.lines != null) {
      ...
      yield serializers.serialize(
        object.lines,
        specifiedType: const FullType(BuiltList, [FullType(DeliveryDetails)]),
      );
    }
  }
...
class V114DeliveryReferringTypeEnum extends EnumClass {
  ...
  static Serializer<V114DeliveryReferringTypeEnum> get serializer => _$v114DeliveryReferringTypeEnumSerializer;

  const V114DeliveryReferringTypeEnum._(String name): super(name);

  static BuiltSet<V114DeliveryReferringTypeEnum> get values => _$v114DeliveryReferringTypeEnumValues;
  static V114DeliveryReferringTypeEnum valueOf(String name) => _$v114DeliveryReferringTypeEnumValueOf(name);
}
