...
import 'package:openapi/src/model/employee_login_request.dart';
...
class AccountApi {
  ...
  ///
  /// Parameters:
  /// * [loginRequest] - Login details of employee for specified app
  ...
  Future<Response<AccountInfo>> employeeLogin({ 
    ...
    try {
      const _responseType = FullType(AccountInfo);
