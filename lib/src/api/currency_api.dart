...
class CurrencyApi {
  ...
  Future<Response<BuiltList<Currency>>> currencyCodes({ 
    ...
    final _path = r'/api/Currency/CurrencyCodes';
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Currency>> currencyCodesById({ 
    ...
    final _path = r'/api/Currency/{CurrencyId}'.replaceAll('{' r'CurrencyId' '}', currencyId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
