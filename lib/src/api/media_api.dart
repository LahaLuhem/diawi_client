...
class MediaApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<MediaInformation>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<MediaInformation>>> media({ 
    int? storeId,
    ...
    BuiltList<MediaInformation> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(MediaInformation)]);
    ...
    return Response<BuiltList<MediaInformation>>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<MediaInformation>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<MediaInformation>>> mediaById({ 
    ...
    final _path = r'/api/Media/{productId}'.replaceAll('{' r'productId' '}', productId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
