...
/// * [mediaHashCode] - Hash code for media
...
abstract class MediaInformation implements Built<MediaInformation, MediaInformationBuilder> {
  ...
  // Dimerce team: MediaInformation.hashCode fix (1.17)
  // change all occurrences of 'hashCode' with 'mediaHashCode' only in this file
  /// Hash code for media
  @BuiltValueField(wireName: r'mediaHashCode')
  String? get mediaHashCode;
...
class _$MediaInformationSerializer implements PrimitiveSerializer<MediaInformation> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.mediaHashCode != null) {
      yield r'mediaHashCode';
      yield serializers.serialize(
        object.mediaHashCode,
        specifiedType: const FullType.nullable(String),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'description':
          ...
          break;
        case r'mediaHashCode':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(String),
          ) as String?;
          if (valueDes == null) continue;
          result.mediaHashCode = valueDes;
          break;
        case r'extension':
          final valueDes = serializers.deserialize(
            value,
