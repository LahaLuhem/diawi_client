...
class OrderSimplifiedOrderStatusEnum extends EnumClass {
  /// Status of order (Quotation = 0, FinancialMonitoring = 1, MarginCheck = 2, EdiCheck = 3, Active = 4, ReleasedInternalDelivery = 6, Parked = 10, Cancelled = 97, Processed = 98, Blocked =99)
  // Dimerce team: Order Simplified Order Status enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 0)
  static const OrderSimplifiedOrderStatusEnum quotation =
      _$orderSimplifiedOrderStatusEnum_quotation;

  /// Status of order (Quotation = 0, FinancialMonitoring = 1, MarginCheck = 2, EdiCheck = 3, Active = 4, ReleasedInternalDelivery = 6, Parked = 10, Cancelled = 97, Processed = 98, Blocked =99)
  // Dimerce team: Order Simplified Order Status enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 1)
  static const OrderSimplifiedOrderStatusEnum financialMonitoring =
      _$orderSimplifiedOrderStatusEnum_financialMonitoring;

  /// Status of order (Quotation = 0, FinancialMonitoring = 1, MarginCheck = 2, EdiCheck = 3, Active = 4, ReleasedInternalDelivery = 6, Parked = 10, Cancelled = 97, Processed = 98, Blocked =99)
  // Dimerce team: Order Simplified Order Status enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 2)
  static const OrderSimplifiedOrderStatusEnum marginCheck =
  ...
  static const OrderSimplifiedOrderStatusEnum releasedInternalDelivery =
  ...
  static const OrderSimplifiedOrderStatusEnum cancelled =
      _$orderSimplifiedOrderStatusEnum_cancelled;

  /// Status of order (Quotation = 0, FinancialMonitoring = 1, MarginCheck = 2, EdiCheck = 3, Active = 4, ReleasedInternalDelivery = 6, Parked = 10, Cancelled = 97, Processed = 98, Blocked =99)
  // Dimerce team: Order Simplified Order Status enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 98)
  static const OrderSimplifiedOrderStatusEnum processed =
  ...
  static Serializer<OrderSimplifiedOrderStatusEnum> get serializer =>
      _$orderSimplifiedOrderStatusEnumSerializer;

  const OrderSimplifiedOrderStatusEnum._(String name) : super(name);

  static BuiltSet<OrderSimplifiedOrderStatusEnum> get values =>
      _$orderSimplifiedOrderStatusEnumValues;
  static OrderSimplifiedOrderStatusEnum valueOf(String name) =>
      _$orderSimplifiedOrderStatusEnumValueOf(name);
}
