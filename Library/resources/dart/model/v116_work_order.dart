...
import 'package:mavis_client/src/model/schedule.dart';
...
import 'package:mavis_client/src/model/work_order_class.dart';
import 'package:mavis_client/src/model/attached_file.dart';
import 'package:mavis_client/src/model/amount.dart';
import 'package:mavis_client/src/model/v112_work_order_detail.dart';
...
class _$V116WorkOrderSerializer implements PrimitiveSerializer<V116WorkOrder> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.details != null) {
      ...
      yield serializers.serialize(
        object.details,
        specifiedType: const FullType.nullable(BuiltList, [FullType(V112WorkOrderDetail)]),
      );
    }
...
class V116WorkOrderTypeEnum extends EnumClass {
  /// Work order type (0=External, 1=Maintenance, 2=Inspection, 3=Internal)
  // Dimerce team: V116WorkOrder type enum key name fix (1.17)
