...
@BuiltValue()
abstract class V111CustomerEmployee
    implements Built<V111CustomerEmployee, V111CustomerEmployeeBuilder> {
  ...
  factory V111CustomerEmployee([void updates(V111CustomerEmployeeBuilder b)]) =
      _$V111CustomerEmployee;
...
class V111CustomerEmployeeAppIdEnum extends EnumClass {
  /// Id of partner that submits request: 0 = Salesforce, 1 = Centix, 2 = Other
  // Dimerce team: V111CustomerEmployee AppId enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 0)
  static const V111CustomerEmployeeAppIdEnum salesforce =
  ...
  static Serializer<V111CustomerEmployeeAppIdEnum> get serializer =>
      _$v111CustomerEmployeeAppIdEnumSerializer;

  const V111CustomerEmployeeAppIdEnum._(String name) : super(name);

  static BuiltSet<V111CustomerEmployeeAppIdEnum> get values =>
      _$v111CustomerEmployeeAppIdEnumValues;
  static V111CustomerEmployeeAppIdEnum valueOf(String name) =>
      _$v111CustomerEmployeeAppIdEnumValueOf(name);
}
