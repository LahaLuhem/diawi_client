...
@BuiltValue()
abstract class WorkOrderDetailChangeRequest
    implements Built<WorkOrderDetailChangeRequest, WorkOrderDetailChangeRequestBuilder> {
  ...
  factory WorkOrderDetailChangeRequest([void updates(WorkOrderDetailChangeRequestBuilder b)]) =
      _$WorkOrderDetailChangeRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WorkOrderDetailChangeRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WorkOrderDetailChangeRequest> get serializer =>
      _$WorkOrderDetailChangeRequestSerializer();
}

class _$WorkOrderDetailChangeRequestSerializer
    implements PrimitiveSerializer<WorkOrderDetailChangeRequest> {
  @override
...
class WorkOrderDetailChangeRequestLineTypeEnum extends EnumClass {
  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 6=Hours
  // Dimerce team: WorkOrder Detail Change Request Line Type enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 0)
  static const WorkOrderDetailChangeRequestLineTypeEnum product =
      _$workOrderDetailChangeRequestLineTypeEnum_product;

  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 6=Hours
  // Dimerce team: WorkOrder Detail Change Request Line Type enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 1)
  static const WorkOrderDetailChangeRequestLineTypeEnum special =
      _$workOrderDetailChangeRequestLineTypeEnum_special;

  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 6=Hours
  // Dimerce team: WorkOrder Detail Change Request Line Type enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 2)
  static const WorkOrderDetailChangeRequestLineTypeEnum cost =
      _$workOrderDetailChangeRequestLineTypeEnum_cost;

  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 6=Hours
  // Dimerce team: WorkOrder Detail Change Request Line Type enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 3)
  static const WorkOrderDetailChangeRequestLineTypeEnum text =
      _$workOrderDetailChangeRequestLineTypeEnum_text;

  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 6=Hours
  // Dimerce team: WorkOrder Detail Change Request Line Type enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 4)
  static const WorkOrderDetailChangeRequestLineTypeEnum composition =
      _$workOrderDetailChangeRequestLineTypeEnum_composition;

  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 6=Hours
  // Dimerce team: WorkOrder Detail Change Request Line Type enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 5)
  static const WorkOrderDetailChangeRequestLineTypeEnum component =
      _$workOrderDetailChangeRequestLineTypeEnum_component;

  /// Linetype: 0=Article, 2=Costs, 3=Text, 4=Composition, 6=Hours
  // Dimerce team: WorkOrder Detail Change Request Line Type enum key name fix (1.17)
  @BuiltValueEnumConst(wireNumber: 6)
  static const WorkOrderDetailChangeRequestLineTypeEnum hours =
      _$workOrderDetailChangeRequestLineTypeEnum_hours;

  static Serializer<WorkOrderDetailChangeRequestLineTypeEnum> get serializer =>
  ...
  static BuiltSet<WorkOrderDetailChangeRequestLineTypeEnum> get values =>
      _$workOrderDetailChangeRequestLineTypeEnumValues;
  static WorkOrderDetailChangeRequestLineTypeEnum valueOf(String name) =>
      _$workOrderDetailChangeRequestLineTypeEnumValueOf(name);
}
